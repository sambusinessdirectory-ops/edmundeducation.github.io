...
export async function openOriginalPaper({answers,owner,task=1,onAnswer=()=>{},audio=null}) {
 ...
 if(!document.querySelector('[data-original-paper-css]')){const css=document.createElement('link');css.rel='stylesheet';css.href=new URL('./dse-listening-original-paper.css?v=20260917-inline-tasks1',import.meta.url);css.dataset.originalPaperCss='';document.head.append(css);}
 ...
 try {
  dialog.querySelector('.original-paper-pages').innerHTML=render2016DigitalPaper(answers,activeTask);

...
-- Flashcard attempts are append-only learning history.  This helper is kept in
-- the shared-account bootstrap file so re-running this file cannot silently
-- restore the old destructive `value = excluded.value` behaviour.

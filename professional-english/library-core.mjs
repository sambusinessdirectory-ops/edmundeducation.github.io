...
export function sourceLink(source){return source?.page?`<a class="poly-source" href="./library.html?view=materials&amp;lesson=${Number(source.lesson)}&amp;page=${Number(source.page)}" target="_blank" rel="noopener">課文首次出現：${escapeHtml(sourceLabel(source))} <svg class="pro-ui-arrow" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M6 18 18 6M6 6h12v12"/></svg></a>`:'';}

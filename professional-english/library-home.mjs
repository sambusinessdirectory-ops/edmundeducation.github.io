import {rpc,session} from './learning-state.mjs?v=20260916-library1';
import {escapeHtml as esc} from './library-core.mjs?v=20260916-library1';
export function mountLibraryHome(host,owner){
 let active=true,busy=false;
 host.innerHTML=`<section class="library-home"><div><p class="pro-eyebrow">WORDS · MATERIALS · YOUR PHRASES</p><h2>尋找詞語，帶回工作現場</h2></div><form action="./library.html" class="library-home-search"><input type="hidden" name="view" value="search"><label class="sr-only" for="professional-all-search">搜尋所有課文、字卡及練習</label><input id="professional-all-search" name="q" type="search" maxlength="200" required placeholder="搜尋英文或中文，查看課堂及頁數…"><button type="submit">搜尋</button></form><nav><a href="./library.html?view=materials">課文與 PDF 下載</a><a href="./library.html?view=bookmarks">片語書籤與播放清單</a><a href="./library.html?view=messages">${owner.user.role==='admin'?'發布／管理課程訊息':'課程訊息'}</a></nav><section class="home-messages" aria-label="課程訊息"><h3>老師的訊息</h3><div data-home-messages><p>正在載入…</p></div></section></section>`;

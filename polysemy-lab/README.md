...
### 2026-09-23 audio expansion

The sentence audio cycle uses Kokoro af_heart (American female), Cloudflare Aura2 Aries (American male), Kokoro bm_fable (British male), and Kokoro bf_isabella (British female). Question voice assignment stays pinned to source-order index and is unaffected by shuffled presentation. The expanded manifest covers 2,838 of 3,692 exercise sentences; the original 33 Show questions remain covered by `audio.json`. Modules 16–32 keep their already-published three-voice mapping; modules 1–15 and 33–91 use the four-voice cycle. The 854 remaining American-male clips are explicitly listed in `audio-pending.json` because the Cloudflare free speech quota was exhausted. No alternate voice was substituted and no paid quota was used. The playback UI continues to disable only those pending clips. The new locally generated clips were transcribed during generation and checked against their source text.

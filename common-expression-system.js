...
function syncExpressionMap() {
  ...
  expressionMapModule ||= Promise.all([
    import("./common-expression-map.mjs?v=20260915-mascot4"),
    SYSTEM_KEY === "business-speaking" ? import("./common-expression-airport.mjs?v=20260915-train1").then(async module => { await module.prepareAirport(); return module; }) :

...
function syncExpressionMap() {
  ...
  expressionMapModule ||= Promise.all([
    import("./common-expression-map.mjs?v=20260915-noirceleste1"),
    SYSTEM_KEY === "business-speaking" ? import("./common-expression-airport.mjs?v=20260915-lounge2").then(async module => { await module.prepareAirport(); return module; }) :

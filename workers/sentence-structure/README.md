...
For an existing production installation that already supports `ss1`–`ss4`,
apply only the forward migration
`../../supabase-sentence-structure-lessons-5-39.sql`. It widens the permitted
...
validated bearer token. Only catalog version `1`, lessons `ss1`–`ss39`, their
...
2,000 items are rejected. Existing bookmark creation timestamps survive updates.

...
const enhancements=read('professional-enhancements.js');assert.match(enhancements,/36 個詞語 · 720 題練習/);assert.match(enhancements,/draft:lesson4-notice/);assert.match(enhancements,/l4d1-beginner/);

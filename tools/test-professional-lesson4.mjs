...
const enhancements=read('professional-enhancements.js');assert.match(enhancements,/36 個詞語 · 720 題練習/);assert.match(enhancements,/draft:lesson4-notice/);assert.match(enhancements,/l4d1-beginner/);const practice=read('dialogue-practice.mjs');assert.match(practice,/pro-whatsapp-practice/);assert.match(practice,/pro-whatsapp-composer/);assert.match(dialogueJs,/Miss Karen Wong/);

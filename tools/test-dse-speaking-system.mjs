...
assert.ok(appSource.includes("dseNativeSourceMarkup") && readFileSync(new URL("dse-speaking-source.js", repository), "utf8").includes("dse-native-source-list"), "digitized source text must preserve paragraphs and numbered lists");

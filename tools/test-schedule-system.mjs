...
assert.equal(homepageCards.length, 58, "homepage must contain all 58 linked category cards");
...
assert.match(scheduleHtml, /schedule-system\.js\?v=20260821-celebration1/);

...
assert.equal(homepageCards.length, 62, "homepage must contain all 62 linked category cards, including Eddie Farm and Membership");
...
assert.match(scheduleHtml, /schedule-system\.js\?v=20260908-refine7/);
...
assert.match(scheduleJs, /HOMEWORK_CATALOG_URL = "\.\/homework-resource-catalog\.mjs\?v=20260901-homework-workflow1"/);

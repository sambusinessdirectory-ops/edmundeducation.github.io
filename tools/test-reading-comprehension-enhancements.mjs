...
assert.match(professionalHtml, /professional-enhancements\.css\?v=20260922-lesson4/, 'day contrast and chart CSS is cache-busted for the current dialogue release');

...
assert.match(professionalHtml, /professional-enhancements\.css\?v=20260911-dialogues1/, 'day contrast and chart CSS is cache-busted for the current dialogue release');

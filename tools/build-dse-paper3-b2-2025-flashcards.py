#!/usr/bin/env python3
"""Build the 2025 DSE Paper 3 B2 Data File flashcard seed from its PDF export."""
...
DECK_ID = "dse/paper-3/part-b-data-file-b2/2025"
EXPECTED_PAGE_COUNT = 28
EXPECTED_CARD_COUNT = 301
EXPECTED_EXAMPLE_COUNT = 5
DEFAULT_OUTPUT = Path(__file__).resolve().parent.parent / "flashcards-dse-paper3-b2-2025-data.js"
...
def build_output(cards: list[dict[str, object]], source_name: str):
    ...
    return (
        ...
        "tools/build-dse-paper3-b2-2025-flashcards.py. */\n"

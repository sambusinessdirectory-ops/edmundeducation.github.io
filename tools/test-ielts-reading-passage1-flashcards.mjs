...
assert(html.includes('<script src="flashcards-audio-manifest.js?v=edmund-neural-v1-20260729-2"></script>'), "Flashcard audio cache key is stale");
...
if (!dataOnly) {
  ...
  assert(audioMeta.count === 67163, `Expected 67,163 manifest entries, found ${audioMeta.count}`);

...
THIRD_BATCH_R2_PREFIX = "IELTS Writing Task 1/IELTS Writing Task 3 - Third Batch"
CATEGORIES = {
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Folder containing the 10 third-batch IELTS Task 1 PDFs",
    )
    parser.add_argument(
        "--third-r2-prefix",
        default=THIRD_BATCH_R2_PREFIX,
        help="R2 prefix containing the third-batch PDFs",
    )

...
assert(html.includes('<script src="flashcards-audio-manifest.js?v=edmund-neural-v1-20260818-1"></script>'), "Flashcard audio cache key was not refreshed for the latest audio release");

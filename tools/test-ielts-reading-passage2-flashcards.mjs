...
assert(html.includes('<script src="flashcards-audio-manifest.js?v=edmund-neural-v1-20260827-1"></script>'), "Flashcard audio cache key was not refreshed for the latest audio release");

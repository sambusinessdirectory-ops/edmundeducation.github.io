...
test('closet UI is responsive and cache-busted on every shared-map consumer', () => {
  ...
  ]) assert.match(read(file), file === 'common-expression-business-speaking.html' ? /common-expression-system\.js\?v=20260915-noirceleste1/ : /\.js\?v=20260915-noirceleste1/, file);
});

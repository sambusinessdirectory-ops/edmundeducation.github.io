...
assert.equal(HOMEWORK_RESOURCE_CATALOG.length, 6050, "the Homework/Schedule catalogue should include every current learning resource, Speaking mock mode, Reading Comprehension exercise, downloadable file, Common Expression lesson, IELTS Listening part, Polysemy lesson, Native English lesson and learning portal");
...
assert.equal(mappedReadingCatalogueIds.size, 457, "453 unique analyses should cover all 457 currently available Passage 1, 2 and 3 catalogue positions");

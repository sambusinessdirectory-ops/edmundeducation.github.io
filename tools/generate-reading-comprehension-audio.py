...
def main() -> int:
    ...
    relative_path = f"assets/reading-comprehension/audio/edmund-neural/{BUILD_VERSION}/{digest[:2]}/{ARTICLE_ID}-{digest[:24]}.mp3"
    ...
    entry = {
        ARTICLE_ID: {
            ...
            "duration": round(elapsed_samples / sample_rate, 3), "wordCount": len(words), "words": words,
        }
    }
    meta = {
        "engine": "Kokoro-82M", "buildVersion": BUILD_VERSION, "voice": VOICE,
        "voiceLabel": "活潑英式女聲", "language": LANGUAGE, "speed": SPEED,

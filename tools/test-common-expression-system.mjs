...
test("all six Common Expression portals carry their identity, shared navigation and PWA security metadata", () => {
  for (const portal of portals) {
    ...
    for (const contract of [
      ...
      portal.key === "speaking" ? /common-expression-system\.js\?v=20260911-map2/ : /common-expression-system\.js\?v=20260908-loading1/,
    ...
    const engineIndex = html.indexOf(`common-expression-system.js?v=${portal.key === "speaking" ? "20260911-map2" : "20260908-loading1"}`);

...
test("all six Common Expression portals carry their identity, shared navigation and PWA security metadata", () => {
  for (const portal of portals) {
    ...
    for (const contract of [
      ...
      portal.key === "business-speaking" ? /common-expression-system\.js\?v=20260924-closet-coins1/ : /common-expression-system\.js\?v=20260924-closet-coins1/,
      /shared-speaking-practice\.css\?v=20260829-1/,
      /<script defer src=["']shared-speaking-practice\.js\?v=20260829-2["']><\/script>/,
      /shared-system-nav\.css\?v=20260924-wallet1/,
    ...
    const engineIndex = html.indexOf(`common-expression-system.js?v=${portal.key === "business-speaking" ? "20260924-closet-coins1" : "20260924-closet-coins1"}`);

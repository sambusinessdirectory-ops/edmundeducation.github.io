...
test("all six Common Expression portals carry their identity, shared navigation and PWA security metadata", () => {
  for (const portal of portals) {
    ...
    for (const contract of [
      ...
      portal.key === "business-speaking" ? /common-expression-system\.js\?v=20260914-airport1/ : portal.key === "rhetorical-writing" ? /common-expression-system\.js\?v=20260913-blueprint1/ : portal.key === "rhetorical-speaking" ? /common-expression-system\.js\?v=20260912-coast2/ : ["speaking", "written"].includes(portal.key) ? /common-expression-system\.js\?v=20260912-garden1/ : /common-expression-system\.js\?v=20260908-loading1/,
    ...
    const engineIndex = html.indexOf(`common-expression-system.js?v=${portal.key === "business-speaking" ? "20260914-airport1" : portal.key === "rhetorical-writing" ? "20260913-blueprint1" : portal.key === "rhetorical-speaking" ? "20260912-coast2" : ["speaking", "written"].includes(portal.key) ? "20260912-garden1" : "20260908-loading1"}`);

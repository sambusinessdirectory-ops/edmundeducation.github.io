...
test("all six Common Expression portals carry their identity, shared navigation and PWA security metadata", () => {
  for (const portal of portals) {
    ...
    for (const contract of [
      ...
      portal.key === "business-speaking" ? /common-expression-system\.js\?v=20260915-airport2/ : /common-expression-system\.js\?v=20260914-portals1/,
    ...
    const engineIndex = html.indexOf(`common-expression-system.js?v=${portal.key === "business-speaking" ? "20260915-airport2" : "20260914-portals1"}`);

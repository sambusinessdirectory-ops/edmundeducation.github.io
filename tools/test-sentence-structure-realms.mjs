...
test('all four realms retain full painted overview coverage',()=>{
 assert.equal(SENTENCE_REALMS.width,1600);assert.equal(SENTENCE_REALMS.height,8284);assert.equal(SENTENCE_REALMS.minimumZoom,.5);assert.deepEqual(SENTENCE_REALMS.cameraPadding,{left:800,right:800});

...
export const steps=[
 {id:'surprise',label:'發現驚喜',title:'你會怎樣點兩球雪糕？',intro:'你走進雪糕店，想點兩球雪糕。下面這句很有禮貌，但有一個字不是點餐時慣用的說法。',sentence:'Can I get two balls of ice cream, please?',questions:['spot'],reveal:'點雪糕時，通常說 two scoops of ice cream。ball 著重球形；scoop 在這裡表示舀出來的一份。這屬於「意思可能聽得懂，但搭配不慣用」，不是整句文法都錯了。',model:'Can I get two scoops of ice cream, please?',zh:'我想要兩球雪糕，謝謝。'},
 {id:'listen',label:'聽懂店員',title:'店員在問甚麼？',intro:'先播放店員的問題，再選擇意思。已經在談雪糕，就不用每次重複 of ice cream。',model:'One scoop or two?',zh:'一球還是兩球？',questions:['listen']},
 {id:'choose',label:'選對訂單',title:'選對句子，才會拿到想吃的口味',intro:'你想要兩球士多啤梨雪糕。哪一句符合你的需要？',questions:['choose']},
 {id:'blanks',label:'自己填空',title:'不看選項，你還記得嗎？',intro:'一球用 scoop；兩球或以上用 scoops。大小寫和前後空格不影響答案。',questions:['blank1','blank2','blank3']},
 {id:'speak',label:'開口練習',title:'換你說一次',intro:'先聽示範，再錄下自己讀這句話的聲音。這是選做練習，可以跳過。',model:'Can I get two scoops of chocolate ice cream, please?',zh:'我想要兩球朱古力雪糕，謝謝。',recording:'phrase',questions:[]},
 {id:'cup',label:'第二個驚喜',title:'等等，店員又問了一句！',intro:'你已經說了兩球，店員卻接著問 Cup or cone? 這次是在問甚麼？',model:'Cup or cone?',zh:'用杯子還是甜筒裝？',questions:['cup']},
 {id:'dialogue',label:'完成點餐',title:'完成你自己的小訂單',intro:'你的訂單：兩球雲呢拿雪糕，用杯子裝。把自己的回答補完整。',questions:['dialogue1','dialogue2','dialogue3'],recording:'dialogue',model:'Can I get two scoops of vanilla ice cream, please? In a cup, please.',zh:'我想要兩球雲呢拿雪糕，謝謝。用杯子裝，謝謝。'},
...
export const questions=[
 mc('spot','你會換掉哪個字？',['get','two','balls','please'],'balls','點雪糕通常用 scoop 表示一球；兩球是 two scoops。'),
 mc('listen','店員想知道甚麼？',['你想要哪種口味？','你要一球還是兩球？','你想不想試吃？','你需要加醬嗎？','你要杯子還是甜筒？','你準備付款了嗎？'],'你要一球還是兩球？','想要兩球，可以回答 Two scoops, please.'),
 mc('choose','你想要兩球士多啤梨雪糕。',['Can I try the strawberry ice cream?','Can I get one scoop of strawberry ice cream?','Can I get two scoops of chocolate ice cream?','Can I get two scoops of strawberry ice cream?','Can I get extra strawberry sauce?','Can I get one scoop of vanilla ice cream?'],'Can I get two scoops of strawberry ice cream?','two scoops 是兩球；strawberry 是士多啤梨。其他句子也可以使用，只是表達不同需要。'),
 blank('blank1','一球雲呢拿雪糕','Can I get one','of vanilla ice cream, please?','scoop','one 後面用單數。'),
 blank('blank2','兩球朱古力雪糕','Can I get two','of chocolate ice cream, please?','scoops','two 後面要加 s：scoops。'),
 blank('blank3','兩球士多啤梨雪糕','Can I get','of strawberry ice cream, please?','two scoops','兩球＝two scoops；請填兩個字。'),
 mc('cup','這次店員是在問……',['你要一球還是兩球？','你要朱古力還是雲呢拿？','你要用杯子還是甜筒裝？','你要不要加朱古力醬？','你要不要再點一份？','你要現金還是刷卡？'],'你要用杯子還是甜筒裝？','scoop 是份量；cup / cone 是容器。用杯子裝：In a cup, please. 用甜筒裝：In a cone, please.'),
 blank('dialogue1','店員：What can I get you?｜先填份量單位','Can I get two','of vanilla ice cream, please?','scoops','兩球用 two scoops。'),
 blank('dialogue2','接著填口味：雲呢拿','Can I get two scoops of','ice cream, please?','vanilla','雲呢拿口味是 vanilla。'),
